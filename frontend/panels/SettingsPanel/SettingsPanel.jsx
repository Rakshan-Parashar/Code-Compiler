...
const FONTS   = ['Consolas','JetBrains Mono','Fira Code','Cascadia Code','Source Code Pro','Monaco','Menlo']
    ...
    <div className={S.backdrop} onMouseDown={e => e.target === e.currentTarget && onClose()}>
      <div className={S.panel} style={{ width: 700, maxHeight: '80vh' }}>
        ...
        <div className={S.footer}>
          <button className={S.resetBtn} onClick={() => { onUpdate({ accentColor:'#7C3AED', fontSize:14, fontFamily:'Consolas', tabSize:2 }); notify?.('info','Settings reset to defaults') }}>
            Reset Defaults
          </button>
